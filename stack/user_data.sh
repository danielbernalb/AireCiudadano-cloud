...
export PUBLIC_IP="88.99.187.134"
...
cd $HOME
git clone --branch cambios22NS_26junio2024_oriact https://github.com/danielbernalb/aireciudadano-cloud.git
...
sudo microk8s.helm3 install aireciudadanostack aireciudadano-cloud/stack/aireciudadanocloud --set tls=false --set publicIP="$PUBLIC_IP" --set grafanaAdminPass="$GRAFANA_ADMIN_PASSWORD"
#===========================================================