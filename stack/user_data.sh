...
for application in prometheus pushgateway grafana mosquitto letsencrypt thanos
do
...
cd $HOME
git clone --branch cambios22NS_10junio2024 https://github.com/danielbernalb/aireciudadano-cloud.git
